...
const pizzaFaceItems: MenuItem[] = [
  {
    ...
    category: "pizzaface", image: "/food-pizza-v2.png", isHot: true,
  },
  {
    ...
    category: "pizzaface", image: "/food-pizza-v2.png",
  },
  {
...
const pizzaItems: MenuItem[] = [
  {
    ...
    category: "pizza", image: "/food-pizza-v2.png", isHot: true,
  },
  {
    ...
    category: "pizza", image: "/food-pizza-v2.png",
  },
  {
...
const pizzaBurItems: MenuItem[] = [
  {
    ...
    category: "pizzabur", image: "/food-pizza-v2.png",
  },
  {
...
const rollItems: MenuItem[] = [
  {
    ...
    category: "roll", image: "/food-roll-v2.png",
  },
  {
...
const crepeItems: MenuItem[] = [
  ...
  },
  {
    ...
    price: 20, calories: 330, category: "crepes", image: "/food-crepe-chicken.png", isHot: true,
  },
  {
...
const sweetItems: MenuItem[] = [
  ...
  },
  {
    ...
    category: "sweet", image: "/food-helw-custard.png", isHot: true,
  },
  {
...
const potatoItems: MenuItem[] = [
  {
    ...
    price: 10, calories: 130, category: "potato", image: "/food-savory.png",
  },
  {
    id: "pt2", name: "مشوية فرانكفورتر", description: "بطاطس مشوية، زبدة، موزريلا، فرانكفورتر",
    price: 14, calories: 150, category: "potato", image: "/food-savory.png",
  },
];

// ─── إضافات (9 items) ───
const extrasItems: MenuItem[] = [
  { id: "e1", name: "موزريلا", description: "إضافة جبن موزريلا إضافية", price: 8, calories: 150, category: "extras", image: "/food-mushaltat.png" },
  { id: "e2", name: "دجاج", description: "إضافة دجاج", price: 8, calories: 110, category: "extras", image: "/food-mushaltat.png" },
  { id: "e3", name: "سجق", description: "إضافة سجق", price: 7, calories: 140, category: "extras", image: "/food-mushaltat.png" },
  { id: "e4", name: "بسطرمة", description: "إضافة بسطرمة", price: 10, calories: 130, category: "extras", image: "/food-mushaltat.png" },
  { id: "e5", name: "سوسيس", description: "إضافة سوسيس", price: 7, calories: 120, category: "extras", image: "/food-mushaltat.png" },
  { id: "e6", name: "مخلل", description: "إضافة مخلل", price: 2, calories: 50, category: "extras", image: "/food-mushaltat.png" },
  { id: "e7", name: "رانش", description: "صوص رانش إضافي", price: 2, calories: 40, category: "extras", image: "/food-mushaltat.png" },
  { id: "e8", name: "باربكيو", description: "صوص باربكيو إضافي", price: 2, calories: 60, category: "extras", image: "/food-mushaltat.png" },
  { id: "e9", name: "هالبينو", description: "فلفل هالبينو إضافي", price: 2, calories: 40, category: "extras", image: "/food-mushaltat.png" },
];
...
export const categories: MenuCategory[] = [
  ...
  { key: "pizzaface", label: "فطير وش بيتزا", labelEn: "Pizza-Faced Pies", image: "/food-pizza-v2.png", items: pizzaFaceItems },
  { key: "pizza", label: "البيتزا", labelEn: "Pizza", image: "/food-pizza-v2.png", items: pizzaItems },
  { key: "pizzabur", label: "بيتزا بُر", labelEn: "Bur Pizza", image: "/food-pizza-v2.png", items: pizzaBurItems },
  { key: "roll", label: "فطيرة رول", labelEn: "Roll Pies", image: "/food-roll-v2.png", items: rollItems },
  ...
  { key: "potato", label: "كمبير", labelEn: "Potato", image: "/food-savory.png", items: potatoItems },
