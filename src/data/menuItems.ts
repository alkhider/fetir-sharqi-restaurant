...
const savoryItems: MenuItem[] = [
  {
    ...
    category: "savory", image: "/food-hadik.png", isHot: true,
  },
  {
  ...
  },
  {
    ...
    category: "savory", image: "/food-hadik.png",
  },
  {
...
const rollItems: MenuItem[] = [
  {
    ...
    category: "roll", image: "/food-hadik.png",
  },
  {
...
const potatoItems: MenuItem[] = [
  {
    ...
    price: 10, calories: 130, category: "potato", image: "/food-hadik.png",
  },
  {
    id: "pt2", name: "مشوية فرانكفورتر", description: "بطاطس مشوية، زبدة، موزريلا، فرانكفورتر",
    price: 14, calories: 150, category: "potato", image: "/food-hadik.png",
  },
];
...
const drinksItems: MenuItem[] = [
  { id: "d1", name: "بيبسي", description: "", price: 3, calories: 86, category: "drinks", image: "/food-mushaltat.png" },
  { id: "d2", name: "كينزا", description: "", price: 2, calories: 111, category: "drinks", image: "/food-mushaltat.png" },
  { id: "d3", name: "شاي", description: "", price: 2, calories: 5, category: "drinks", image: "/food-mushaltat.png" },
