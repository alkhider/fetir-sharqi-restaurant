...
const dishes = [
  ...
  {
    id: 'helw',
    name: 'فطيرة قشطة وعسل',
    nameEn: 'Honey Cream Pie',
...
const marqueeItems = [
  ...
  { name: 'فطيرة سجق', nameEn: 'Sausage Pie', price: 35, image: '/item-s5.png' },
  { name: 'كريب دجاج رانش', nameEn: 'Chicken Ranch Crepe', price: 20, image: '/item-cr2.png' },
  { name: 'فطيرة مكس جبن', nameEn: 'Mix Cheese Pie', price: 29, image: '/item-s2.png' },
  { name: 'فطيرة بسطرمة كيري', nameEn: 'Pastirma Kiri Pie', price: 37, image: '/item-s8.png' },
];
